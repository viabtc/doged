...
func New(activeNet *chaincfg.Params, handlers *rpcclient.NotificationHandlers,
	...
	if handlers.OnFilteredBlockConnected != nil {
		...
		handlers.OnFilteredBlockConnected = func(height int32, header *wire.BlockHeader, filteredTxns []*dogeutil.Tx) {
...
func (h *Harness) SetUp(createTestChain bool, numMatureOutputs uint32) error {
	...
	// wallet.
	filterAddrs := []dogeutil.Address{h.wallet.coinbaseAddr}
...
func (h *Harness) NewAddress() (dogeutil.Address, error) {
...
//
// This function is safe for concurrent access.
func (h *Harness) ConfirmedBalance() dogeutil.Amount {
...
//
// This function is safe for concurrent access.
func (h *Harness) GenerateAndSubmitBlock(txns []*dogeutil.Tx, blockVersion int32,
	blockTime time.Time) (*dogeutil.Block, error) {
...
func (h *Harness) GenerateAndSubmitBlockWithCustomCoinbaseOutputs(
	txns []*dogeutil.Tx, blockVersion int32, blockTime time.Time,
	mineTo []wire.TxOut) (*dogeutil.Block, error) {
	...
	prevBlock := dogeutil.NewBlock(mBlock)
