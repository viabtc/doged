...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr dogeutil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*dogeutil.Tx, error) {
...
func CreateBlock(prevBlock *dogeutil.Block, inclusionTxs []*dogeutil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr dogeutil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*dogeutil.Block, error) {
	...
	blockTxns := []*dogeutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := dogeutil.NewBlock(&block)
