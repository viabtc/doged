...
func (c *Client) SubmitBlockAsync(block *dogeutil.Block, options *btcjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitBlock(block *dogeutil.Block, options *btcjson.SubmitBlockOptions) error {
