...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []dogeutil.Address) FutureListUnspentResult {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []dogeutil.Address) ([]btcjson.ListUnspentResult, error) {
...
func (c *Client) SetTxFeeAsync(fee dogeutil.Amount) FutureSetTxFeeResult {
...
func (c *Client) SetTxFee(fee dogeutil.Amount) error {
...
func (c *Client) SendToAddressAsync(address dogeutil.Address, amount dogeutil.Amount) FutureSendToAddressResult {
...
func (c *Client) SendToAddress(address dogeutil.Address, amount dogeutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address dogeutil.Address,
	amount dogeutil.Amount, comment,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address dogeutil.Address, amount dogeutil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress dogeutil.Address, amount dogeutil.Amount) FutureSendFromResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress dogeutil.Address, amount dogeutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress dogeutil.Address, amount dogeutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress dogeutil.Address, amount dogeutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress dogeutil.Address, amount dogeutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress dogeutil.Address,
	amount dogeutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[dogeutil.Address]dogeutil.Amount) FutureSendManyResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[dogeutil.Address]dogeutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[dogeutil.Address]dogeutil.Amount,
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[dogeutil.Address]dogeutil.Amount, minConfirms int,
...
func (r FutureAddMultisigAddressResult) Receive() (dogeutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return dogeutil.DecodeAddress(addr, &chaincfg.MainNetParams)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []dogeutil.Address, account string) FutureAddMultisigAddressResult {
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []dogeutil.Address, account string) (dogeutil.Address, error) {
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []dogeutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []dogeutil.Address) (*btcjson.CreateMultiSigResult, error) {
...
// address.
func (r FutureGetNewAddressResult) Receive() (dogeutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetNewAddress(account string) (dogeutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (dogeutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddress(account string) (dogeutil.Address, error) {
...
// address.
func (r FutureAddWitnessAddressResult) Receive() (dogeutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) AddWitnessAddress(address string) (dogeutil.Address, error) {
...
func (r FutureGetAccountAddressResult) Receive() (dogeutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddress(account string) (dogeutil.Address, error) {
...
func (c *Client) GetAccountAsync(address dogeutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetAccount(address dogeutil.Address) (string, error) {
...
func (c *Client) SetAccountAsync(address dogeutil.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) SetAccount(address dogeutil.Address, account string) error {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]dogeutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	addrs := make([]dogeutil.Address, 0, len(addrStrings))
	for _, addrStr := range addrStrings {
		addr, err := dogeutil.DecodeAddress(addrStr,
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]dogeutil.Address, error) {
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount dogeutil.Amount) FutureMoveResult {
...
func (c *Client) Move(fromAccount, toAccount string, amount dogeutil.Amount) (bool, error) {
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	amount dogeutil.Amount, minConfirms int) FutureMoveResult {
...
func (c *Client) MoveMinConf(fromAccount, toAccount string, amount dogeutil.Amount, minConf int) (bool, error) {
...
func (c *Client) MoveCommentAsync(fromAccount, toAccount string,
	amount dogeutil.Amount, minConfirms int, comment string) FutureMoveResult {
...
func (c *Client) MoveComment(fromAccount, toAccount string, amount dogeutil.Amount,
...
func (c *Client) ValidateAddressAsync(address dogeutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) ValidateAddress(address dogeutil.Address) (*btcjson.ValidateAddressWalletResult, error) {
...
func (r FutureListAccountsResult) Receive() (map[string]dogeutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]dogeutil.Amount)
	for k, v := range accounts {
		amount, err := dogeutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccounts() (map[string]dogeutil.Amount, error) {
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]dogeutil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (dogeutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := dogeutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// Receive waits for the response promised by the future and returns the
// available balance from the server for the specified account.
func (r FutureGetBalanceParseResult) Receive() (dogeutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetBalance(account string) (dogeutil.Amount, error) {
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (dogeutil.Amount, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (dogeutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (dogeutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (dogeutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (dogeutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalance(account string) (dogeutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (dogeutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address dogeutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
// confirmations.
func (c *Client) GetReceivedByAddress(address dogeutil.Address) (dogeutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address dogeutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetReceivedByAddressMinConf(address dogeutil.Address, minConfirms int) (dogeutil.Amount, error) {
...
func (c *Client) SignMessageAsync(address dogeutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address dogeutil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address dogeutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address dogeutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*dogeutil.WIF, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return dogeutil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address dogeutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address dogeutil.Address) (*dogeutil.WIF, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *dogeutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
...
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *dogeutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *dogeutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *dogeutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *dogeutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *dogeutil.WIF, label string, rescan bool) error {
