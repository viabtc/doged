...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/viabtc/doged/peer)
...
```bash
$ go get -u github.com/viabtc/doged/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/viabtc/doged/peer#example-package--NewOutboundPeer)  
