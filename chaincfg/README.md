...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/viabtc/doged/chaincfg)
...
func main() {
	...
	addr, err := dogeutil.NewAddressPubKeyHash(pubKeyHash, chainParams)
	if err != nil {
		log.Fatal(err)
	}
	fmt.Println(addr)
...
```bash
$ go get -u github.com/viabtc/doged/chaincfg
```
