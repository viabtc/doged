...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/viabtc/doged/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/viabtc/doged/blockchain/fullblocktests
```
