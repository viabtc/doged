...
import (
	...
	"github.com/viabtc/dogeutil/gcs"
	"github.com/viabtc/dogeutil/gcs/builder"
)
...
func storeFilter(dbTx database.Tx, block *dogeutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *dogeutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *dogeutil.Block,
