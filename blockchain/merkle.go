...
// is the zeroHash.
func BuildMerkleTreeStore(transactions []*dogeutil.Tx, witness bool) []*chainhash.Hash {
...
func ExtractWitnessCommitment(tx *dogeutil.Tx) ([]byte, bool) {
...
func ValidateWitnessCommitment(blk *dogeutil.Block) error {
