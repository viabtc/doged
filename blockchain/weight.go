...
func GetBlockWeight(blk *dogeutil.Block) int64 {
...
func GetTransactionWeight(tx *dogeutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *dogeutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
