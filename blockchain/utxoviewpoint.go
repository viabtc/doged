...
func (view *UtxoViewpoint) AddTxOut(tx *dogeutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *dogeutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *dogeutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *dogeutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *dogeutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *dogeutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *dogeutil.Tx) (*UtxoViewpoint, error) {
