...
var (
	defaultHomeDir     = dogeutil.AppDataDir("btcd", false)
...
func loadConfig() (*config, []string, error) {
	...
	cfg.minRelayTxFee, err = dogeutil.NewAmount(cfg.MinRelayTxFee)
	if err != nil {
	...
	cfg.miningAddrs = make([]dogeutil.Address, 0, len(cfg.MiningAddrs))
	for _, strAddr := range cfg.MiningAddrs {
		addr, err := dogeutil.DecodeAddress(strAddr, activeNetParams.Params)
		if err != nil {
